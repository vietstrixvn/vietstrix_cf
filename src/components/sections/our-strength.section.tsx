...
export default function OurStrength() {
  ...
  // Fade-in header items then cards — 2 calls replace the entire useEffect
  const containerRef = useScrollFadeIn<HTMLDivElement>({
    targets: '.strength-header-item',
    trigger: '.strength-header',
    stagger: 0.15,
  });

  const gridRef = useScrollFadeIn<HTMLDivElement>({
  ...
  return (
    ...
    >
      <Container width="max-w-8xl" className="w-full mx-auto px-0 relative z-10">
        ...
        {/* Strength Cards Grid */}
        <div ref={gridRef} className="strength-grid mt-16 md:mt-24 w-full">
            ...
            {features.map((feature) => (
              ...
              >
                <dt className="flex items-start w-full">
                  ...
                  <div className="flex items-center justify-center h-12 w-12 shrink-0  bg-[#013162] text-white hover:scale-105 active:scale-95 transition-transform duration-300 ease-out cursor-pointer select-none">
