...
export default function AuthorCard({ author }: { author: UserProb }) {
  ...
  return (
    <div className="bg-primary-50  p-4 md:p-6 w-full">
            ...
            {Object.entries(author.social_links).map(([platform, url]) => {
              ...
              return (
                <a
                  ...
                  className="flex items-center justify-center p-2 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-200  transition-all duration-200 text-gray-700 hover:text-blue-600 shadow-sm"
