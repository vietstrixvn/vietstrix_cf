...
function ChannelCard() {
  ...
  return (
    <div className="w-full  overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.18)] bg-white font-sans">
      {/* Banner */}
      <div className="relative">
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-center">
          ...
          <button
            ...
            className={` w-9 h-9 flex items-center justify-center transition-all duration-300 ${copied
      ...
      <div className="relative flex justify-center h-[54px]">
        <div className="absolute -top-11 w-[88px] h-[88px]  border-4 border-white overflow-hidden bg-gray-200 shadow-lg">
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-r from-primary-100 via-primary-50 to-primary-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-gradient-to-br from-primary-700 to-transparent  opacity-70 blur-xl animate-float-slow" />
        ...
        <div className="absolute -right-20 top-1/2 w-96 h-96 bg-gradient-to-l from-primary-600 to-transparent  opacity-50 blur-xl animate-float-fast" />
      </div>
          ...
          <section className="space-y-3">
            ...
            <div className="flex items-center gap-3 py-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-gray-700 uppercase tracking-widest whitespace-nowrap px-2 bg-gradient-to-r from-green-50 to-emerald-50 ">
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  key={link.id}
                  className={`group relative flex items-center justify-between w-full  p-5 border-2 transition-all duration-300 overflow-hidden
                      ...
                      <p className="text-sm text-gray-500 mt-1 flex items-center gap-1.5">
                        {link.isActive && (
                          <span className="relative flex h-1.5 w-1.5">
                            <span className="animate-pulse absolute inline-flex h-full w-full  bg-green-500 opacity-75" />
                            <span className="relative inline-flex  h-1.5 w-1.5 bg-green-600" />
                          </span>
                        )}
                        {link.description}
                      </p>
